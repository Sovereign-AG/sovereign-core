...
# Sovereign Protocol: Sovereign Billing Manager (Registry Side)
...
def generate_checkout_url(did: str, agent_name: str) -> Optional[str]:
    ...
    try:
        session = client.checkout_sessions.create(
            ...
            return_url=os.getenv("SOVEREIGN_REGISTRY_URL", "http://127.0.0.1:8000") + f"/v1/status/{did}"
        )
...
def check_activation(did: str) -> Tuple[bool, str]:
    ...
    checkout_url = generate_checkout_url(did, "Sovereign-Agent-Alpha")
