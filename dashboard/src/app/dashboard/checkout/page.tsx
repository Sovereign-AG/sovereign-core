        ...
        <div className="flex items-center space-x-6">
           ...
           <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <span className="font-black text-xs tracking-[0.3em] text-white uppercase italic">Sovereign AG</span>
                <span className="text-[9px] text-zinc-600 font-bold uppercase tracking-widest">Institutional Registry</span>
              </div>
           </div>
        </div>
           ...
           <div className="bg-zinc-950/80 backdrop-blur-md rounded-[3rem] border border-zinc-900 p-12 sticky top-24 space-y-12 shadow-2xl">
              ...
              <div className="space-y-12">
                 <div className="flex justify-between items-start">
                    <div className="space-y-1">
                       <p className="text-[11px] font-black text-white uppercase tracking-widest">Protocol Activation</p>
                       <p className="text-[10px] text-zinc-700 font-black uppercase italic tracking-tighter">Institutional Provisioning</p>
                    </div>
                 ...
                 <div className="pt-10 border-t border-zinc-900 space-y-8">
                    ...
                    <div className="p-5 bg-black border border-zinc-900 rounded-[2rem] text-[10px] text-zinc-600 font-black uppercase text-center tracking-[0.2em] leading-loose">
                       SETTLEMENT CYCLE: WEEKLY (SUNDAY 23:59 IST) <br/>
                       <span className="text-zinc-800">THRESHOLD: $1,000.00 INSTITUTIONAL CAP</span>
                    </div>
                 </div>
              </div>
