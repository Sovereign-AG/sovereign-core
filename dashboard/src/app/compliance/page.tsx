...
import { ShieldCheck, FileText, Lock, CheckCircle2, ShieldAlert } from 'lucide-react';
...
export default function CompliancePage() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-gray-500 font-sans selection:bg-white/10 antialiased">
      <script
      ...
      <main className="max-w-4xl mx-auto px-8 py-32 space-y-24">
        ...
        <section className="space-y-12 bg-[#050505] border border-[#111] text-white rounded-none p-12 relative overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center space-x-4 opacity-40 mb-12">
             <SovereignLogo size={16} />
             <div className="h-4 w-px bg-slate-200" />
             <span className="text-[10px] font-black uppercase tracking-[0.4em]">Compliance Registry</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-none text-white">The Audit Room.</h1>
          <p className="text-2xl text-gray-500 font-medium leading-tight max-w-2xl">
        ...
        <div className="space-y-32">
          ...
          <section className="space-y-8">
            <h2 className="text-3xl font-black tracking-tight underline decoration-[#1A1A1A] underline-offset-8 text-white">How does Sovereign AG satisfy NIST 800-218 Rule 4.2?</h2>
            <p className="text-xl text-gray-400 leading-relaxed font-medium bg-[#050505] p-8 rounded-none border border-[#111] shadow-sm first-letter:text-4xl first-letter:font-black first-letter:mr-1 first-letter:float-left">
          ...
          <section className="space-y-8">
            <h2 className="text-3xl font-black tracking-tight underline decoration-[#1A1A1A] underline-offset-8 text-white">What is the April 2nd, 2026 Compliance Concept Paper?</h2>
            <p className="text-xl text-gray-400 leading-relaxed font-medium bg-[#050505] p-8 rounded-none border border-[#111] shadow-sm font-serif italic text-white/50">
            ...
            <div className="space-y-6 pl-8 border-l-4 border-white">
               ...
               <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-center text-sm font-bold text-white group">
          ...
          <section className="space-y-8">
            <h2 className="text-3xl font-black tracking-tight underline decoration-[#1A1A1A] underline-offset-8 text-white">How does Sovereign AG protect against prompt injection?</h2>
        ...
        <section className="py-20 border-t border-slate-100 text-center space-y-10">
           ...
           <div className="flex flex-col md:flex-row justify-center gap-6">
              <a href="/auth/mint" className="px-10 py-5 bg-white text-black rounded-none font-black uppercase tracking-widest text-[11px] hover:bg-emerald-500 transition-all flex items-center justify-center">
                 Review Sovereign Grant <FileText size={16} className="ml-3" />
              </a>
           </div>
        </section>
      </main>
