...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "SVTP v1.0 Secure Identity Dashboard",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "SVTP v1.0 | Secure AI Infrastructure",
...
const globalSchema = {
  ...
  "@graph": [
    {
      "@type": "Organization",
      "@id": "https://svtp-protocol.org/#organization",
      "name": "SVTP v1.0",
      "url": "https://svtp-protocol.org",
      "logo": "https://svtp-protocol.org/logo.png",
      "description": "The Global Root of Trust for AI Agent Identity and Governance."
    },
    {
      "@type": "Service",
      "name": "SVTP Governance Utility",
      "provider": { "@id": "https://svtp-protocol.org/#organization" },
