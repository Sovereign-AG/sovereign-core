...
const MOCK_DATA = [
  { type: 'SYNC', content: 'SYNC_REQUEST: did:svtp:alpha_9...', status: 'ACTIVE' },
  ...
  { type: 'SYNC', content: 'SYNC_REQUEST: did:svtp:beta_2...', status: 'ACTIVE' },
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          <div className="w-full lg:w-[40%] space-y-8">
            ...
            <p className="text-xl text-gray-500 font-medium leading-relaxed">
              Every action is cryptographically anchored to the SVTP Root before execution. Our high-frequency heartbeat prevents lateral movement and unauthorized state changes in real-time.
            </p>
