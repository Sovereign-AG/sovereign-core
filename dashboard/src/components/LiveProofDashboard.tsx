...
const VERIFIED_LOGS = [
  { id: 'vlog-1', timestamp: '18:26:50', text: '[SVTP] Building Cryptographic DID...', status: 'processing' },
  { id: 'vlog-2', timestamp: '18:26:51', text: '[SVTP] Identity Anchored: did:svtp:7782', status: 'success' },
  { id: 'vlog-3', timestamp: '18:26:51', text: '[SVTP] Heartbeat Syncing (6.42us)...', status: 'processing' },
  { id: 'vlog-4', timestamp: '18:26:51', text: 'SVTP Protocol Seal Issued.', status: 'success' },
  { id: 'vlog-5', timestamp: '18:26:51', text: 'Verified Agent: Requesting tool-call...', status: 'processing' },
  { id: 'vlog-6', timestamp: '18:26:51', text: 'SVTP Authorization: GRANTED', status: 'authorized' },
  { id: 'vlog-7', timestamp: '18:26:51', text: 'Data: {"identity": "did:svtp", "status": "Success"}', status: 'success' },
];

const ROGUE_LOGS = [
  { id: 'rlog-1', timestamp: '18:26:38', text: 'Rogue Agent: Attempting unauthorized tool-call...', status: 'warning' },
  { id: 'rlog-2', timestamp: '18:26:38', text: 'SVTP Rejection: Identity Required', status: 'forbidden' },
  { id: 'rlog-3', timestamp: '18:26:38', text: 'Status: Unauthorized behavioral drift detected.', status: 'error' },
];
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-24 space-y-6">
          ...
          <p className="text-gray-400 text-lg font-medium tracking-tight max-w-2xl leading-relaxed">
            ...
            <span className="text-white">No SVTP-DID = No Access. Period.</span>
          </p>
        </div>
          ...
          <div className="bg-[#050505] p-12 lg:p-16 space-y-10 group">
            ...
            <div className="font-mono text-[14px] leading-loose">
              <pre className="text-gray-400 overflow-x-auto">
                <div className="opacity-40 mb-2"># Install: pip install svtp-sdk</div>
                <div className="text-lime-400">from svtp_sdk import SVTPAgent</div>
                <br/>
                <div className="text-white opacity-90"><span className="text-gray-600">@SVTPAgent.guard()</span></div>
                <div><span className="text-lime-400">def</span> <span className="text-blue-400">secure_trade</span>(payload):</div>
                <div className="pl-6 text-gray-600"># SVTP Root of Trust Active</div>
                <div className="pl-6 text-gray-500"># Identity, JIT-Auth, and Ledger Enabled</div>
                <div className="pl-6 text-lime-400">return process_trade(payload)</div>
              </pre>
            </div>
          ...
          <div className="bg-[#030303] p-12 lg:p-16 space-y-10">
            <div className="flex items-center justify-between">
              ...
              <div className={`text-[10px] font-mono transition-colors duration-500 ${isAuthorized ? 'text-lime-500' : 'text-red-500'}`}>
                {isAuthorized ? 'SVTP_AUTH_SUCCESS' : 'SVTP_AUTH_REQUIRED'}
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-[#1A1A1A] flex justify-between items-center">
               ...
               <span className="text-[9px] font-mono text-gray-700 uppercase tracking-widest">SVTP Root Node: AP-SOUTH-1</span>
            </div>
          </div>
        ...
        <div className="mt-20 flex flex-col items-center space-y-6">
           <div className="flex items-center space-x-4 opacity-30">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.5em] text-white">Universal Root of Trust</span>
              <div className="h-[1px] w-12 bg-white" />
           </div>
        </div>
      </div>
