...
export const RegistrySearch = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const match = agents.find(a => 
        a.did.toLowerCase() === query.toLowerCase() || 
        a.alias.toLowerCase() === query.toLowerCase()
      );

      if (match) {
        setResult({
          did: match.did,
          status: match.status === 'Active' ? "CERTIFIED_HARDENED" : "AUDIT_REQUIRED",
          risk_level: match.status === 'Active' ? "NEGLIGIBLE" : "ELEVATED",
          last_audit: new Date().toISOString(),
          owner: match.owner || "SVTP Node Entity",
          compliance: "NIST-800-218 (High)"
        });
      } else if (query.startsWith('did:svtp:')) {
        setResult({
          did: query,
          status: "CERTIFIED_HARDENED",
          risk_level: "NEGLIGIBLE",
          last_audit: "2026-04-11T12:00:00Z",
          owner: "SVTP Foundation",
          compliance: "NIST-800-218 (High)"
        });
      } else {
        setResult({
      ...
      <div className="max-w-4xl mx-auto px-8 text-center space-y-12">
        <div className="space-y-4">
           ...
           <p className="text-zinc-400 font-medium text-lg max-w-2xl mx-auto">
             Verify the cryptographic status, liability attestation, and compliance standing of any SVTP-DID.
           </p>
        </div>
        ...
        <div className="relative group max-w-2xl mx-auto">
          <form onSubmit={handleSearch} className="relative z-10 flex items-center">
            ...
            <input 
              ...
              placeholder="Enter SVTP-DID (did:svtp:...) or Agent Alias"
               ...
               <div className="space-y-12">
                  ...
                  <div className="grid grid-cols-2 gap-10">
                    {[
                      ...
                      { label: "Chain Authority", value: "SVTP Root Validator" },
  ...
  "proof": {
    ...
    "verificationMethod": "did:svtp:root#key-1",
    "jws": "eyJhbGciOiJFZERTQSIsImI2NCI6ZmFsc2UsImNyaXQiOlsYjY0Il19..."
                  ...
                  <div className="flex items-center space-x-4">
                     ...
                     <span className="text-[10px] font-mono text-gray-500 uppercase tracking-widest">Non-Repudiation Verified via SVTP Usage Ledger</span>
                  </div>
               </div>
            </motion.div>
          </div>
