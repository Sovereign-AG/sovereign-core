...
export default function InstitutionalHandshake({ isOpen, onClose, onConfirm, user }: HandshakeModalProps) {
          ...
          <div className="px-8 pb-8 space-y-6">
            ...
            <div className="space-y-2">
               ...
               <div className="relative group">
                  <div className="w-full bg-[#1E1F20] border border-[#444746] rounded-lg px-4 py-3 flex items-center justify-between hover:border-gray-500 transition-all cursor-pointer">
            ...
            <div className="pt-4 flex justify-end">
               <button 
                onClick={onConfirm}
                className="px-6 py-2.5 bg-[#8AB4F8] text-[#001D35] text-[14px] font-bold rounded-full hover:bg-[#A1C2FA] transition-all shadow-sm"
               >
                 Agree & continue
               </button>
            </div>
