      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div className="space-y-4 text-left">
            ...
            <h2 className="text-5xl font-bold text-white tracking-tight">Active DID Registry</h2>
            <p className="text-zinc-500 font-medium text-lg max-w-2xl leading-relaxed">Real-time attestation for all autonomous nodes cryptographically anchored to the Sovereign Root.</p>
          </div>
            <div className="flex flex-col items-end space-y-4">
              <span className="text-[10px] font-bold text-zinc-700 uppercase tracking-widest">Security Standard: NIST-2026</span>
              <button 
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-800 bg-zinc-900/40">
                <th className="px-8 py-6 text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Agent Identifier</th>
                <th className="px-8 py-6 text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Trust Score</th>
                <th className="px-8 py-6 text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Compliance Status</th>
                ...
                <tr>
                  <td colSpan={4} className="px-8 py-24 text-center">
                    <div className="flex flex-col items-center gap-4">
                       ...
                       <span className="text-zinc-500 font-medium italic">Synchronizing Fleet Ledger...</span>
                    </div>
                  </td>
                </tr>
              ) : agents.length === 0 ? (
