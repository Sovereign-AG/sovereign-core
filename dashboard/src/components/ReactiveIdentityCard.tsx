        ...
        <div className="h-full flex flex-col justify-between relative z-10 [transform:translateZ(40px)]">
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-6">
              ...
              <div className="space-y-1.5">
                <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Identity Status</div>
                <div className="flex items-center space-x-2">
                   <div className="h-1.5 w-1.5 rounded-full bg-yellow-500 shadow-[0_0_8px_rgba(234,179,8,0.4)]" />
                   <span className="text-xs font-semibold text-zinc-200 tracking-tight">Verified Protocol Anchor</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div className="bg-black/40 p-5 border border-zinc-800/50 rounded-xl relative overflow-hidden group/code">
              <div className="text-[10px] font-semibold text-zinc-600 uppercase tracking-widest mb-3">Live Attestation</div>
            ...
            <div className="flex items-center justify-between pt-4">
               <div className="flex flex-col">
                  <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-1">Reputation Score</span>
                  <span className="text-4xl font-bold text-white tracking-tight">99.8</span>
               </div>
               <div className="flex flex-col items-end">
                  <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-1">Issue Date</span>
                  <span className="text-sm font-semibold text-zinc-300 tracking-tight">April 2026</span>
               </div>
            </div>
          </div>
        </div>
